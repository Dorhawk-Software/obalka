...
| **Přenos** | croc (Go přes gomobile), zatím jen Android |
...
- **Minimální iOS je 15.5** (čtečka QR kódů `VisionCameraBarcodeScanner` níž nejde); Android 7.0 (API 24).
...
**Verze 0.0.1, před první beta verzí.** Hotové a odzkoušené na zařízení: účty a přihlášení,
...
QR kód, a **přenos do jiného telefonu** přes jednorázovou frázi (zatím jen Android). Na později zůstává
zálohování do cloudu (Google Drive, iCloud) a přenos na iPhonu.
