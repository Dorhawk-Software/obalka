...
**Before the first beta.** Done and walked on a device: accounts and sign-in, messages
...
shown and scanned as a QR code, and a **phone-to-phone transfer** with a one-time phrase, between an
iPhone and an Android phone too. Planned for later: backing up to the cloud (Google Drive, iCloud).
