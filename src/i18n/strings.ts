...
const cs: Record<string, string> = {
  ...
  // Termín row says the alert will not come and offers the one thing that changes that.
  'term.sub.silent':
    'Vlastní připomínka. Upozornění jsou vypnutá, termín uvidíte jen v aplikaci.',
...
const en: Record<string, string> = {
  ...
  'term.sub.silent':
    'Your own reminder. Notifications are off, so you will only see it in the app.',
