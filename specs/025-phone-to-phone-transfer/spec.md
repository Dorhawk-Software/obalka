...
- **iOS background-transfer limits.** A transfer that cannot survive the app being backgrounded is a
  worse experience on iOS than Android, and FR-014 forbids the usual workaround.
